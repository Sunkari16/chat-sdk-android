...
import co.chatsdk.ui.custom.inbox.ManchAbstractChatOptionsHandler;

/**
 * Created by ben on 10/11/17.
 */

public class DialogChatOptionsHandlerManch extends ManchAbstractChatOptionsHandler {

    private AlertDialog dialog;
    private boolean hasExecuted = false;

    public DialogChatOptionsHandlerManch(ChatOptionsDelegate delegate) {
        super(delegate);
    }
