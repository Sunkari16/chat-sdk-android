...
import co.chatsdk.ui.custom.inbox.handlers.TextMessageDisplayHandlerManch;
...
/**
 * a basic chat view handler for showing the user and participant views
 */
public class PrivateChatAdapter extends RecyclerView.Adapter<AbstractMessageViewHolder> {
    ...
    public PrivateChatAdapter(AppCompatActivity activity) {
        this.activity = activity;
    }

    @NonNull
    @Override
    public AbstractMessageViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int type) {
        ...
        if (handler != null) {
            ...
            handler = new TextMessageDisplayHandlerManch();
            return handler.newViewHolder(isReply, activity);
        }
    }
